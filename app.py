...
gradient_text_html = """
  ...
  <div class="gradient-text">‎‎ ‎ ‎ ‎ ‎ ‎  GeetorusGPT2</div>
  """
...
if LOGGED_IN == True and agree:
  ...
  def aicode(text):
      ...
      model = ChatGoogleGenerativeAI(model="gemini-pro", convert_system_message_to_human=True, google_api_key="AIzaSyCuazXYy5WRlQuy9MqTrJ_LtqGTSsBTQhE")
      # data = model(
      # [
  ...
  sidebar_content = """
  Introduction:
  Our AI bot, GeetorusGPT2, is a revolutionary tool designed for ethical hacking. With a commitment to integrity and effectiveness, it empowers users to enhance their cybersecurity efforts while adhering to ethical standards.
  
  Key Features:
  - Code-based Questions: GeetorusGPT2 excels at answering queries related to coding, offering insights into programming languages, algorithms, and best practices for secure coding.
  - Tool-based Questions: Whether it's about specific cybersecurity tools or techniques, GeetorusGPT2 provides comprehensive responses, guiding users on the utilization and optimization of various tools in their cybersecurity arsenal.
  - Instructions: GeetorusGPT2 offers clear and concise instructions for executing specific cybersecurity tasks, ensuring users can implement effective strategies to fortify their defenses.
  ...
  With GeetorusGPT2, users can trust in its expertise and ethical approach to enhance their cybersecurity practices effectively."""
